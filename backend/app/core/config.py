...
class Settings(BaseSettings):
    ...
    DB_PASSWORD: str  # Database password - REQUIRED in .env
    ...
    def construct_database_url(cls, v, values):
        ...
        # Always construct from components to ensure correct password encoding
        ...
        return f"mysql+pymysql://{db_user}:{password_encoded}@{db_host}:{db_port}/{db_name}"
