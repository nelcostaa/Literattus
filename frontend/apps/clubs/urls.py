...
urlpatterns = [
    ...
    path('<int:club_id>/discussions/create/', views.create_discussion, name='create_discussion'),
    path('<int:club_id>/books/nominate/<str:book_id>/', views.nominate_book, name='nominate_book'),
]
